...
<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
    ...
    <StackPanel Spacing=""2"" Padding=""12,8"">
        ...
        private bool _windowStylesInitialized;

        private void InitializeWindowStyles()
        {
            if (_windowStylesInitialized)
                return;
            _windowStylesInitialized = true;
            ...
            NativeMethods.SetLayeredWindowAttributes(_hwnd, TRANSPARENT_COLOR_KEY, 255, NativeMethods.LWA_COLORKEY);
        ...
        private void PositionWindow(IntPtr dialogHwnd)
        {
            ...
            var visibleCount = System.Math.Min(_items.Count, _maxVisibleItems);
        ...
        {
            return NativeMethods.GetAppWindow(_hwnd != IntPtr.Zero ? _hwnd : WinRT.Interop.WindowNative.GetWindowHandle(this));
        }
    }
}
